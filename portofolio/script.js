...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (preloader) {
        setTimeout(() => {
            ...
            // Start reveal animations AFTER preloader hides
            // so users actually SEE the animations play
...
function initRevealAnimations() {
    ...
    // Failsafe: force-reveal after 3 seconds in case observer misses elements
    setTimeout(() => {
...
/* =========================================================================
   ...
   ========================================================================= */
// Failsafe: if preloader never called initRevealAnimations, run after 2.5s
setTimeout(() => {
    initRevealAnimations();
}, 2500);
...
if (menuToggle && desktopNav) {
    ...
    // overflow:hidden on body blocks touches on fixed elements in iOS Safari!
    ...
    // Nav link clicks: close menu FIRST, then scroll to section
    desktopNav.querySelectorAll('a').forEach(link => {
        link.addEventListener('click', (e) => {
            ...
            // Smooth scroll to anchor AFTER nav is closed
            if (href && href.startsWith('#')) {
                ...
                if (target) {
                    ...
                    }, 150); // wait for nav close animation
                }
            }
        });
    });
